...
이후, 실무 경험을 쌓고자 자발적으로 식품 이커머스 사업체 '낭만부부'에 데이터 분석을 제안드려 이를 바탕으로 브랜드의 성장을 돕는 그로스 마케터 겸 비즈니스 분석가의 커리어를 시작했습니다.
...
| --- | --- | --- |
| 23.10.30~24.03.03| [Project NMBB: '낭만부부' 네이버스토어 분석을 통한 마케팅 제안](https://github.com/KYK0328/nmbb) | Python |
| 23.10.30~24.03.03| [Project NMBB: '낭만부부' 자사몰 활성화를 위한 그로스 마케팅](https://luluofgang.tistory.com/category/main%20projects/NMBB) | GA4, Bigquery, Excel|
