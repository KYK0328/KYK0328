...
이후, 실무 경험을 쌓고자 식품 이커머스 사업체 '낭만부부'에 데이터 분석을 제안드려 이를 바탕으로 브랜드의 성장을 돕는 그로스 마케터 겸 분석가의 커리어를 시작했습니다.
시행착오를 겪고 있지만 오늘도 정진합니다.
...
| --- | --- | --- |
| 24.01.29~24.02.19| 🍡 Project NMBB(2): [네이버스토어 분석을 통한 마케팅 제안](https://github.com/KYK0328/nmbb_analysis) | Python, Excel |
